...
hitable *iridescent_scene() {
	...
	list[i++] = new sphere(vec3(300, 180, 150), 130, dielecSpect );
	list[i++] = new sphere(vec3(300, 180, 150), 120, iri );
	// 
...
int main() {
	...
	hitable *world = iridescent_scene();
